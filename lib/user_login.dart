...
class _UserLoginState extends State<UserLogin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text("Login"), centerTitle: true, backgroundColor: Colors.pink[600],),
            ...
            children: <Widget> [
              Form(
                ...
                child: Column(
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text("Welcome back!", style: TextStyle(fontSize: 20, color: Colors.black),),
                    SizedBox(height: 40,),
                    TextFormField(
