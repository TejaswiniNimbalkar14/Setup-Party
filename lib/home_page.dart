  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: ListView(
            children: <Widget>[
              ...
              new ListTile(
                ...
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => RegisterRadio()));
                },
              ),
              new Divider(),
              new ListTile(
              ...
              new Divider(),
              new ListTile(
                title: Text("Product Upload", style: TextStyle(fontSize: 18,),),
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => ProductUpload())),
        ...
        body: Center(
          child: Image(
            fit: BoxFit.fill,
            image: NetworkImage("https://www.architectureartdesigns.com/wp-content/uploads/2014/12/20-Fabulous-Balloon-Decorations-You-Can-Get-Ideas-From-For-Your-Next-Celebration-19-630x707.jpg"),
          ),
        )
    );
  }
...
class _RegisterRadioState extends State<RegisterRadio> {
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text("Register as :"), centerTitle: true, backgroundColor: Colors.pink[600],),
      body: SingleChildScrollView(
        child: Container(
          padding: EdgeInsets.fromLTRB(60.0, 180.0, 60.0, 0.0),
          child: Column(
            children: <Widget>[
              RadioListTile(    //User radio button
              ...
              Divider(),
              RadioListTile(    //Vendor radio button
                groupValue: _registerRadio,
                activeColor: Colors.pinkAccent,
                title: Text("Vendor"),
                value: "vendor",
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      if(_registerRadio=='user') {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => SelectShopCategory()));
                      }
                      else
